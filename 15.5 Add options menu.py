    ...
    while not EndGame:     #Running the game
        ...
        if not Animate:
            ...
            if Xtra == False:  #arent any extra matches
                ...
                if not isinstance(P1, numbers.Real) and not isinstance(P2, numbers.Real) and P1 != P2:
                    ...
                    if NumOfMatched != 0: # if there is a match
